...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "CricMaster is a professional ball-by-ball cricket scoring app with toss, two-innings flow, live scoreboard, scorecards, player & team stats and leagues." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "CricMaster — Pro Live Cricket Scoring" },
      { property: "og:description", content: "Broadcast-grade live cricket scoring: toss, two innings, scorecards, stats, leagues and more." },
      { property: "og:site_name", content: "CricMaster" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "CricMaster — Pro Live Cricket Scoring" },
      { name: "twitter:description", content: "Broadcast-grade live cricket scoring: toss, two innings, scorecards, stats, leagues and more." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/By7cNN90pQPVSrTKR08ZptMFPgH2/social-images/social-1782363771830-cricmaster.webp" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/By7cNN90pQPVSrTKR08ZptMFPgH2/social-images/social-1782363771830-cricmaster.webp" },
    ],
    links: [
      {
        rel: "stylesheet",
